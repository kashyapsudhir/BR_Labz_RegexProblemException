...
namespace RegexExceptionProblem
{
    public class RegexClass
    {
       ...
       // public static string PasswordRules = "^[0-9 A-Z a-z]{8,}$";//UC5
        //public static string PasswordRules1 = "^([A - Z]{0,1})[0-9A-Za-z]{8,}$";//UC6
        //public static string PasswordRules2 = "^[A-Z]{1,}[A-Za-z0-9]{1,10}";//UC7
        public static string PasswordRules = "^(?=[a-zA-Z0-9#@$?-_]{8,}$)(?=.*?[a-z])(?=.*?[A-Z])(?=.*?[0-9]).*$";//UC8
        public static string UC9EmailRules = (@"^(?=.*[A-Za-z])(?=.*\d)(?=.*[@$!%*#?&])[A-Za-z\d@$!%*#?&]{8,}$");//UC9
        ...
        public void ValidEmailUC9(string EmailCheck)
        {
            try
            {
